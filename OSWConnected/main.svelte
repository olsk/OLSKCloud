...
<button class="OSWConnectedDisconnectButton" on:click={ () => window.confirm(OLSKLocalized('OSWConnectedDisconnectConfirmText')) && mod.InterfaceDisconnectButtonDidClick() }>{ OLSKLocalized('OSWConnectedDisconnectButtonText') }</button>
